...
class ProductsSearch extends StatefulWidget {
  ...
  const ProductsSearch({
    Key? key,
    required this.listIdProductSelected,
    required this.otherSearch,
...
class _ProductsSearchState extends State<ProductsSearch> {
  ...
  Future<List<Product>> loadProductSearch() async {
    List<Product> products = [];

    widget.listIdProductSelected != null
        ? await Supabase.instance.client
            .from('products')
            .select()
            .inFilter('id', widget.listIdProductSelected!)
            .then((list) {
            // print(list);
    ...
    await Supabase.instance.client
        .from('products')
        .select()
        .inFilter('id', widget.otherSearch)
        .then((list) {
    ...
    //---- ------
    List remainingList = [...widget.otherSearch];
    if (widget.listIdProductSelected != null) {
      remainingList.addAll(widget.listIdProductSelected!);
    }
    await Supabase.instance.client
        .from('products')
        .select()
